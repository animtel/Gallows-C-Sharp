...
namespace Hangman_Game
{
    ...
    {       
        ...
        public bool AddGuessedLetters(char letter)
        {
            ...
            {
                Console.WriteLine();
                Console.WriteLine("'" + letter.ToString().ToUpper() + "' Не подходящий тип буквы");
                return false;
            }
            else if (!this.GuessedLetters.Contains(letter.ToString().ToUpper())) // Add guessed letter iif it is not exists
            {
                ...
                Console.WriteLine();
                Console.WriteLine("Написанные буквы : " + buildString(GuessedLetters, true));
                return true;
            }
            else // letter is exists
            {
                Console.WriteLine();
                Console.WriteLine("Вы уже писали эту вукву '" + letter.ToString().ToUpper() + "'");
            }
            return false;
        }
